...
class Solution {
    ...
    public int diameterOfBinaryTree(TreeNode root) {
        ...
        // System.out.printf("val: %d, leftBranch: %d, rightBranch: %d %n", root.val, leftBranch, rightBranch);
    ...
    public int longestBranch(TreeNode node) {
        ...
        // System.out.printf("val: %d, leftBranch: %d, rightBranch: %d %n", node.val, leftBranch, rightBranch);
        // System.out.println("longestBranch: " + (Math.max(leftBranch, rightBranch) + 1));
        // System.out.println("current MAX: " + max);
